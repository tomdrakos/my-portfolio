    ...
    <>
      <div class="wrapper">
        <div class="wrapper__links">
          <a class="social-link social-link--github" id="github" href="https://github.com/tomdrakos">
            <svg
              class="social-svg"
              viewBox="0 0 600 600"
          ...
          <a class="social-link social-link--linkedin" id="linkedin" href="https://www.linkedin.com/in/tomasz-ponikowski/">
            <svg
              class="social-svg"
              viewBox="0 0 600 600"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a class="social-link social-link--instagram" id="instagram" href="https://www.instagram.com/ponioinsta/">
            <svg
              class="social-svg"
              viewBox="0 0 600 600"
              xmlns="http://www.w3.org/2000/svg"
